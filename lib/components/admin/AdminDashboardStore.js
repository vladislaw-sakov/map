...
var WunderlistDashboarStore = Object.assign({}, EventEmitter.prototype, {
   ...
   getListsWithCountFiltered : function () {
    ...
    //    get all completed/created tasks by day of week mapped to count
...
AppDispatcher.register(function(action){
    switch( action.actionType ) {
        case AdminDashboardConstants.RECEIVE_LIST_DATA:
            _listData = action.lists;
            generateNameMapForListData( action.lists );
            WunderlistDashboarStore.emitChange();
            break;
        case AdminDashboardConstants.RECEIVE_LIST_TASKS:
            receiveListTasks( action.listId.toString(), action.tasks );
            WunderlistDashboarStore.emitChange();
            break;
        case AdminDashboardConstants.RECEIVE_LIST_COMPLETED_TASKS:
            ...
            WunderlistDashboarStore.emitChange();
            break;
        case AdminDashboardConstants.TASKS_FETCH_STARTED:
            _isLoading = true;
            WunderlistDashboarStore.emitChange();
            break;
        case AdminDashboardConstants.ALL_TASKS_FETCHED:
            _isLoading = false;
            WunderlistDashboarStore.emitChange();
            break;
    }
